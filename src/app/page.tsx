...
const Home: NextPage = () => {
  ...
  const addToCart = (product: Product) => {
    const filterCart = cartItems?.filter((currProduct) => {
    ...
    localStorage.setItem("block3market-cart", JSON.stringify(newCart));
      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <footer className="bg-gray-900 py-6 mt-12">
          <div className="container mx-auto px-4 text-center text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} Block3Market. All rights
              reserved.
            </p>
          </div>
        </footer>
